...
export const CONTENT_MODULE_SLOTS: readonly ContentModuleSlotDefinition[] = [
  ...
  { id: "settings-preferences", screen: "settings", label: { ko: "앱 설정", zh: "应用设置", ja: "アプリ設定", en: "App settings" }, accepts: { ko: "언어 사용자 설정", zh: "语言用户设置", ja: "言語ユーザー設定", en: "Language user settings" } },
] as const;
